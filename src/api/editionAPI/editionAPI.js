...
export function EDITION_UPDATE(data) {
  return request({
    url: process.env.BASE_API + '/edition/edit',
    method: 'post',
    data,
    headers: {
      'token': getToken()
...
export function EDITION_DETAIL(id) {
  return request({
    url: process.env.BASE_API + '/edition/detail?edition_id=' + id,
    method: 'get',
    headers: {
      'token': getToken()
    }
...
export function edition_join_device(data) {
  return request({
    url: process.env.BASE_API + '/edition/join-device',
    method: 'post',
    data,
    headers: {
      'token': getToken()
