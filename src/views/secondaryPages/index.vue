<template>
  <div class="device-list app-container">
            ...
            <el-row>
              ...
              <el-col :span="10">
                <el-form ref="filterForm" :model="filterForm" :inline="true" label-width="100px" class="filter-form">
                  ...
                  <el-form-item label="" prop="storeId"  style="float:right;margin-right:20px;">
                    <el-select
                      class="searchInput"
    ...
    <el-dialog :before-close="handleCloseE" :close-on-click-modal="false" :visible.sync="editVisible" class="edit-form" title="编辑内容">
      ...
      <el-form ref="editForm" :model="editForm" :rules="editRules">
        <el-form-item :label-width="labelWidth" label="内容名称" prop="storeId">
          <el-input v-model="editForm.storeId" placeholder="请输入内容名称" :maxlength="30"/>
        </el-form-item>
        ...
        <el-form-item :label-width="labelWidth" label="展现形式" prop="roomNo">
          ...
          <el-form-item v-if="editForm.roomNo==2" :label-width="labelWidth" label="上传视频：" prop="videos"></el-form-item>
        </el-form-item>
      </el-form>
    ...
    <el-dialog :before-close="handleCloseA" :close-on-click-modal="false" :visible.sync="addVisible" class="edit-form" title="新建二级页面">
      <el-form ref="addForm" :model="addForm" :rules="addRules">
        ...
        <el-form-item :label-width="labelWidth" label="布局分类" prop="brandCode">
        ...
        <el-form-item :label-width="labelWidth" label="背景图" prop="backgroundImage">
          <el-button @click="showAddContDialog('innerVisible', true)">选择内容</el-button>
        </el-form-item>
        <div class="imageBox"><img :src="addForm.backgroundImage"></div>
        <el-form-item :label-width="labelWidth" label="广告内容" prop="adImage">
          <el-button @click="showAddContDialog('innerVisible', true)">选择内容</el-button>
        </el-form-item>
